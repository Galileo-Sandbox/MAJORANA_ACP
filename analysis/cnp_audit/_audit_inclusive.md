...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 | 0.595 | 0.888 | 0.946 | 0.063 | 0.180 | 0.268 | ↓ overconfident (σ too tight) |
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 |   1.24 |  -1.37 | 0.171 | ~ marginal |
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 |  41.58 | -22.56 | 1.1e-112 | ✗ local miss |
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 |  24.46 | +18.82 | 4.7e-79 | ✗ local miss |
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 |   0.46 |  -0.55 | 0.580 | ✓ clean |
...
**FE 2614**
  ...
  17. `flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2` — p_DT=0.171, Z_DT= -1.37, χ²_DT=  1.24  ·  ~ marginal
...
**SE 2103**
  ...
  13. `physics_pe9_attn_gated` — p_DT=0.023, Z_DT= -2.28, χ²_DT=  1.21  ·  ✗ local miss
  14. `physics_pe10_attn_gated` — p_DT=2.1e-07, Z_DT= -5.19, χ²_DT=  2.87  ·  ✗ local miss
  15. `physics_w10_varN` — p_DT=2.0e-42, Z_DT=-13.65, χ²_DT= 17.35  ·  ✗ local miss
  16. `physics_pure_attn4x64` — p_DT=4.8e-43, Z_DT=-13.75, χ²_DT= 16.62  ·  ✗ local miss
  17. `physics_peOff_attn_gab_dense` — p_DT=3.4e-52, Z_DT=-15.20, χ²_DT= 36.09  ·  ✗ local miss
  18. `w10_fixed48` — p_DT=1.9e-61, Z_DT=-16.54, χ²_DT= 33.91  ·  ✗ local miss
  19. `true_cnp` — p_DT=8.9e-73, Z_DT=-18.04, χ²_DT= 38.81  ·  ✗ local miss
  20. `hyper_zoom_w5` — p_DT=4.5e-74, Z_DT=-18.21, χ²_DT= 28.99  ·  ✗ local miss
  21. `flat_attn1_fullgated_dgsfn_tied_bandfilter_sl1` — p_DT=1.7e-90, Z_DT=-20.17, χ²_DT= 37.16  ·  ✗ local miss
  22. `w10_varN_large` — p_DT=2.7e-96, Z_DT=-20.82, χ²_DT= 43.45  ·  ✗ local miss
  23. `flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2` — p_DT=1.1e-112, Z_DT=-22.56, χ²_DT= 41.58  ·  ✗ local miss
...
**DEP 1592**
  ...
  20. `flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2` — p_DT=4.7e-79, Z_DT=+18.82, χ²_DT= 24.46  ·  ✗ local miss
...
**Bi 1620**
  ...
  11. `flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2` — p_DT=0.580, Z_DT= -0.55, χ²_DT=  0.46  ·  ✓ clean
  12. `physics_pe9_attn_gated` — p_DT=0.580, Z_DT= -0.55, χ²_DT=  0.49  ·  ✓ clean
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 | 0.0034 | 0.195 | -0.473 |
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 | 0.0043 | 0.203 | -0.578 |
...
| flat_attn1_fullgated_dgsfn_tied_hardfilter_sl2 | 5659 | 1415 | +0.488 | -0.0074 | 0.595 |
